...
public interface ArchiveAgentMapper {
    ...
    @Mapping(target = "archiveDate", source = "agentHistory.archiveHistory.archiveDate")
    @Mapping(target = "reason", source = "agentHistory.archiveHistory.reason")
    ArchiveAgentDto toArchiveAgentDto(AgentEntity agent);
}
